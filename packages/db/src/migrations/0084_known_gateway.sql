...
ALTER TABLE "cost_events" ADD COLUMN "model_definition_id" uuid;--> statement-breakpoint
...
ALTER TABLE "model_definitions" ADD CONSTRAINT "model_definitions_company_id_companies_id_fk" FOREIGN KEY ("company_id") REFERENCES "public"."companies"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "model_prices" ADD CONSTRAINT "model_prices_pricing_tier_id_model_pricing_tiers_id_fk" FOREIGN KEY ("pricing_tier_id") REFERENCES "public"."model_pricing_tiers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "model_pricing_tiers" ADD CONSTRAINT "model_pricing_tiers_model_id_model_definitions_id_fk" FOREIGN KEY ("model_id") REFERENCES "public"."model_definitions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "model_definitions_company_name_idx" ON "model_definitions" USING btree ("company_id","model_name");--> statement-breakpoint
CREATE INDEX "model_definitions_provider_idx" ON "model_definitions" USING btree ("provider");--> statement-breakpoint
CREATE INDEX "model_prices_tier_usage_idx" ON "model_prices" USING btree ("pricing_tier_id","usage_type");--> statement-breakpoint
CREATE INDEX "model_pricing_tiers_model_priority_idx" ON "model_pricing_tiers" USING btree ("model_id","priority");--> statement-breakpoint
...
ALTER TABLE "cost_events" ADD CONSTRAINT "cost_events_model_definition_id_model_definitions_id_fk" FOREIGN KEY ("model_definition_id") REFERENCES "public"."model_definitions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
